...
#' 
#' Le descrizioni degli argomenti qui sotto sono state riprese da pag. 31 (un po' in francese, un po' in italiano)
#' del documento metodologico dell'Ust (ESS, Programmes R pour l'intervalle de confiance de la MEDIANE)
#' 
...
statMed <- function(x, strata = NULL, psu = NULL, nh = NULL, th = NULL, 
    ...
    return(cbind(l.limit, u.limit, median=med, cvs95, cvs, 
