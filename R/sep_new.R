# Provo una nuova versione di sep()
...
#' @export
sep2 <- function(x, probs = 0.5, strata = NULL, psu = NULL, nh = NULL, 
  ...
  # does it
  # if (!is.null(crit) & any(is.na(Ah)) & length(Ah[!is.na(Ah)])>0) {  # Ah:=NA sostituito con !is.na(Ah)
